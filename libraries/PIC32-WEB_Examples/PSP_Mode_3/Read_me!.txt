To run "PIC32-WEB_PSP_Demo" on Olimex's "PIC32-WEB" board is required:
1. Program "PIC32-WEB" on-board microcontroller "PIC32MX460F512L-80I/PT" with "PIC32-WEB_PSP_Demo.hex"
2. Remove "PIC32-WEB" power supply and insert "MOD-ENC624J600" board into corresponding EXT1 and ExT2 connectors.
3. Check and make sure that all "MOD-ENC624J600" and "PIC32-WEB" jumper are set to be in PSP Mode 3.
   Correct jumpers positions are shown in "PIC32-WEB" schematic. (See the drawn table, column  "PSP MODE 3 (Default)" )
